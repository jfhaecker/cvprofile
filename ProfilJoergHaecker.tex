...
Die Arbeitsweise in einem Softwareentwicklungsteam ist mir somit bestens bekannt.  
Als Scrum Master lege besonders viel Wert auf die Erstellung eines ``Done``-Inkrementes, das auch wirklich ``Done`` ist. Im skalierten Scrum-Umfeld müssen dazu die Abhängigkeiten zwischen den Teams möglichst früh betrachtet werden.  
}
...
Leistungen
\begin{itemize}
\item Scrum Master für mehrere Entwicklungsteams in einem skalierten Scrum-Umfeld (50 Enwickler*Innen+).
...
\item Moderation des Nexus-Daily bestehend aus Abgesandten der Teams, um einen gemeinsamen Plan für die nächsten 24h zu entwickeln.
