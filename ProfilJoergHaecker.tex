...
Als Scrum Master lege besonders viel Wert auf die Erstellung eines ``Done``-Inkrementes, das auch wirklich ``Done`` ist.
}
...
Leistungen
\begin{itemize}
\item Scrum Master für mehrere Entwicklungsteams in einem auf dem Nexus-Framework basierenden Skalierungsansatz.
